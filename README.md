...
## 👥 Autores 
Este proyecto fue realizado en equipo por [@segoviaroswill](https://github.com/segoviaroswill) y [@Luischacom](https://github.com/Luischacom). Trabajamos de forma conjunta, compartiendo el mismo entorno de trabajo y tomando decisiones en pareja durante todo el proceso. Ambos contribuimos en:
